---
title: "NetDx analysis on chronic lymphocytic leukemia"
author: "Jonas Bohn"
date: "1/14/2021"
...
## Apply NetDx on chronic lymphocytic leukemia (CLL)

This protocol contains the performed netDx patient stratification on CLL data from MOFAdata package as an example use case for supervised multi-omics data integration. We are aiming a transparent step by step procedure. We used the existing repository of netDx for creating this script (http://bioconductor.org/packages/release/bioc/vignettes/netDx/inst/doc/BuildPredictor.html). This study is part of our  published work (Multi-omics methodologies and tools for biomarker and molecular network identification in translational cancer research).
